...
func TestConfigParserRejectsUnknownFieldsAndUnfrozenFormalEnvironment(t *testing.T) {
	...
	if err := os.WriteFile(unknownPath, []byte(`{"schema_version":"experiment-matrix-v5","unknown":true}`), 0o600); err != nil {
		t.Fatal(err)
	}
