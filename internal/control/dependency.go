...
// DependencyInformation identifies the information-acquisition path. Static
...
type DependencyInformation string

const (
	DependencyInformationRuntime       DependencyInformation = "runtime_observed"
	DependencyInformationStaticProgram DependencyInformation = "static_program"
)

func ValidDependencyInformation(information DependencyInformation) bool {
	switch information {
	case DependencyInformationRuntime, DependencyInformationStaticProgram:
		return true
	default:
		return false
	}
...
type DependencyCounters struct {
	...
	Information                  DependencyInformation `json:"information"`
